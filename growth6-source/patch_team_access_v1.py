...
def patch_html(html: str, css: str, management_css: str, sofa_css: str, js: str, group_js: str, management_js: str, sofa_js: str) -> str:
    for start, end in (
        (CSS_START, CSS_END),
        (JS_START, JS_END),
        (GROUP_JS_START, GROUP_JS_END),
        (MANAGEMENT_CSS_START, MANAGEMENT_CSS_END),
        (MANAGEMENT_JS_START, MANAGEMENT_JS_END),
        (SOFA3_CSS_START, SOFA3_CSS_END),
        (SOFA3_JS_START, SOFA3_JS_END),
    ):
    ...
    required = [
        ...
        'Ежедневный отчёт Роману зафиксирован',
    ]
...
def main() -> None:
    ...
    html = patch_html(source.read_text(encoding='utf-8'), css, management_css, sofa_css, js, group_js, management_js, sofa_js)
    ...
    metadata = {
        ...
        'features': [
            ...
            'sofa-operational-day',
            'sofa-daily-control-checklist',
            'sofa-management-rhythm',
            'sofa-daily-funnel-and-payments',
            'sofa-owner-daily-report',
            'sofa-weekly-result-score',
            'sofa-meeting-templates-history-actions',
            'sofa-manager-motivation',
    ...
    for folder in ('growth-os', 'growth-os-6', 'growth61-live'):
        ...
        (out / 'RELEASE.txt').write_text(
            'EXTREME KIDS Growth OS 6.5 Sofa Operations\n'
