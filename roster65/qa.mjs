...
r = rosterApply(s, mentor, { action: 'remove', requestId: randomUUID(), groupId: 'qa-roster', childId: first.childId, membershipId: first.membershipId, previousUpdatedAt: m.updatedAt, reason: 'Переезд' }, P, '2026-09-16'); s = r.data;
